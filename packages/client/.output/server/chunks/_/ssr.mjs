import { createFileRoute, lazyRouteComponent, createRootRoute, Outlet, HeadContent, Scripts, RouterProvider, Link, createRouter as createRouter$1 } from '@tanstack/react-router';
  ...
  return createServerFnStaticCache({
    getItem: async (ctx) => {
      if (typeof document === "undefined") {
        ...
        const publicUrl = "C:/code/indy-network/packages/client/.output/public";
        const {
          promises: fs2
